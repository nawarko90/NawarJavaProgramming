...
public class UniqueElements {
    public static void main(String[] args) {
        ...
        unique2.removeIf(p -> Collections.frequency(list2,p)>1);// remove the non unique elements=unique
        System.out.println("unique2 = " + unique2);
        // so we can solve it with loop or with lambda to find the unique element
