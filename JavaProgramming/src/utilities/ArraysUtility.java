...
public class ArraysUtility {
    ...
    //check if the given integer is contained in the given array. returns boolean. contain (int[], int)
    ...
    //check if the given double is contained in the given array. returns boolean. contain (double[], double)
    ...
    //check if the given char is contained in the given array. returns boolean. contain (char[], char)
    ...
    //check if the given String is contained in the given array. returns boolean. contain (String[], String)
